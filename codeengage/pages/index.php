...
<div class="flex flex-1 min-h-screen items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
    <section class="text-center max-w-2xl mx-auto p-10 rounded-2xl shadow-2xl bg-gray-900/90 border border-gray-800 flex flex-col items-center space-y-8">
        <h1 class="text-5xl md:text-6xl font-extrabold text-blue-400 tracking-tight">Write less. Learn faster. Share smarter.</h1>
        <p class="text-lg md:text-2xl text-gray-300 font-mono">A developer-focused platform to save, share, and discover code snippets.</p>
        <a href="/pages/login.php" class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded shadow-lg transition text-lg focus:outline-none focus:ring-2 focus:ring-blue-400 mt-2">
            <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            Get Started
        </a>
    </section>
</div>
